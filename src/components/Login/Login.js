...
const Login = (props) => {
  ...
  const emailChangeHandler = (event) => {
    ...
    setFormIsValid(
      event.target.value.includes('@') && passwordState.isValid && entredCollege.trim().length
    );
  ...
  const passwordChangeHandler = (event) => {
    ...
    setFormIsValid(
      emailState.isValid && event.target.value.trim().length > 6 && entredCollege.trim().length
    );
  ...
  const collegeChangeHandler=(event)=>{
    ...
    setFormIsValid(
      emailState.value.includes('@') && passwordState.isValid && event.target.value.trim().length >6
    );
  }
